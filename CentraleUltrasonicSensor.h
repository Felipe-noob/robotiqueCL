 ...
 * @file    CentraleUltrasonicSensor.h
 * @author  MakeBlock
 * @version V1.0.1
 * @date    2016/06/25
 * @brief   Header for for CentraleUltrasonicSensor.cpp module
 *
 * \par Copyright
 ...
 * </pre>
 */
#ifndef CentraleUltrasonicSensor_H
#define CentraleUltrasonicSensor_H
 ...
 * Class: CentraleUltrasonicSensor
 * \par Description
 * Declaration of Class CentraleUltrasonicSensor.
 */
#ifndef ME_PORT_DEFINED
class CentraleUltrasonicSensor
#else // !ME_PORT_DEFINED
class CentraleUltrasonicSensor : public MePort
#endif // !ME_PORT_DEFINED
{
public:
#ifdef ME_PORT_DEFINED
 ...
 */
  CentraleUltrasonicSensor(uint8_t port);
#else // ME_PORT_DEFINED
/**
 * Alternate Constructor which can call your own function to map the ultrasonic Sensor to arduino port,
