 ...
 * \class CentraleUltrasonicSensor
 * \brief   Driver for Me ultrasonic sensor device.
 * @file    CentraleUltrasonicSensor.cpp
 * @author  MakeBlock
 * @version V1.0.3
 * @date    2023-10-26
 * @brief   Driver for Me ultrasonic sensor device.
 ...
 * \par Method List:
 *
 *    1. void CentraleUltrasonicSensor::setpin(uint8_t SignalPin)
 *    2. double CentraleUltrasonicSensor::distanceCm(uint16_t MAXcm)
 *    3. long CentraleUltrasonicSensor::measure(unsigned long timeout)
 *
 * \par History:
 * <pre>
 ...
 * Felipe LORENZZON 2023/10/26     1.0.4            Add a timeoout function
 * </pre>
 *
 ...
 *   None
 */
CentraleUltrasonicSensor::CentraleUltrasonicSensor(void) : MePort(0)
{
 ...
 */
CentraleUltrasonicSensor::CentraleUltrasonicSensor(uint8_t port) : MePort(port)
{
 ...
 */
CentraleUltrasonicSensor::CentraleUltrasonicSensor(uint8_t port)
{
  _SignalPin = port;
 ...
 *   None
 */
void CentraleUltrasonicSensor::setpin(uint8_t SignalPin)
{
 ...
 *   None
 */
double CentraleUltrasonicSensor::distanceCm(uint16_t MAXcm)
{
 ...
 *   None
 */
long CentraleUltrasonicSensor::measure(unsigned long timeout)
{
  long duration;
